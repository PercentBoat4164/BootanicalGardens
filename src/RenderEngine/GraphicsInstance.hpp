...
public:
  ...
  static std::unordered_set<uint64_t> enabledExtensions;
  ...
  /**
   * Check the availability of instance extensions. This function <em>must</em> be called before using any functionality provided by an instance extension.
   *
